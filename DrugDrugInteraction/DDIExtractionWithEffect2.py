...
if __name__=="__main__":
    ...
    for res in results:
        ...
        for i in range(0,len(cells)):
            extract = ''
            effect = ''
            if cells[i].rowN in spanningRows or cells[i].isHeader or cells[i].rowN==drugset:
                continue
            ...
            # Get drug name from the table based on SetID
                ...
                cursor.execute(sql,(idArticle,SpecId,idTable,TableOrder,drugname,extract,effect,"DDI Method 3",isGroup))
